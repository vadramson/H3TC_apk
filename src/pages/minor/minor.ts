...
export class MinorPage {
  ...
  majorCourseData = {"user": "", "id": ""};
   ...
   dropMinor(ordIDNum){
    if (ordIDNum){
      ...
      this.h3tcApiProvider.postData(this.majDel, "drop/minor/courses/").then((result) => {
        this.responseData = result;
        if (this.responseData.minor) {
          this.my_majorCourses=this.responseData.minor;
          this.loadMinorCourses();
  ...
  addMinor() {
    if(this.majorCourseData.user && this.majorCourseData.id){
      this.h3tcApiProvider.postData(this.majorCourseData, "add/minor/courses/").then((result) => {
        this.responseData = result;
  ...
  loadMinorCourses() {
    ...
    this.h3tcApiProvider.postData(this.courserData, "get/all/minor/courses/").then((result) => {
      this.responseData = result;
      if (this.responseData.minor) {
        this.my_majorCourses=this.responseData.minor;
        console.log("this.my_majorCourses");
